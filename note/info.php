...
$itemId = $_GET['id'] ?? '1400146';

$info = null;

$info = json_decode(file_get_contents('./392djfklj920klsdaf3j290sdpofjwpaoj12-ri0294.json'), true);

$url = 'https://talk-pilsner.kakao.com/emoticon/api/store/v3/items/' . $itemId . '?referer=one_tap';
...
echo respond($statusCode == 0, $statusCode, $searchres ?? (object)[]);
?>
